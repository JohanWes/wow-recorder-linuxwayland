...
const KOREAN: Translations = {
  ...
  [Phrase.UpdateStageDownloading]: '업데이트 다운로드 중…',
  [Phrase.UpdateStageVerifying]: '체크섬 검증 중…',
  [Phrase.UpdateStageInstalling]: '업데이트 설치 중…',
  [Phrase.UpdateStageRelaunching]: '앱 재시작 중…',
  [Phrase.UpdateFailedText]: '업데이트 실패. 다시 시도하거나 닫으세요.',
  [Phrase.UpdateInstalledRelaunching]: '업데이트 설치 완료 — 앱 재시작 중…',
  [Phrase.Saving]: '저장...',
