...
const ENGLISH: Translations = {
  ...
  [Phrase.NoVideosHint]: 'If you expected to see videos here, check that your settings in "General" are set correctly, and that the recorder says "Ready" in the top left.',
  ...
  [Phrase.ObsCaptureModeDescription]: 'The capture mode OBS should use to record.',
  ...
  [Phrase.CrashHappenedText]: 'An error has occured. This can result in dropped videos. You may wish to seek help by sharing your WCR and OBS logs on the GitHub issues page.',
  ...
  [Phrase.UpdateStageDownloading]: 'Downloading update…',
  [Phrase.UpdateStageVerifying]: 'Verifying checksum…',
  [Phrase.UpdateStageInstalling]: 'Installing update…',
  [Phrase.UpdateStageRelaunching]: 'Relaunching app…',
  [Phrase.UpdateFailedText]: 'Update failed. You can retry or close this dialog.',
  [Phrase.UpdateInstalledRelaunching]: 'Update installed — relaunching the app…',
