...
const CHINESE_SIMPLIFIED: Translations = {
  ...
  [Phrase.ObsCaptureModeDescription]: 'OBS 用于录制的捕获模式。',
  ...
  [Phrase.CrashHappenedText]: 'OBS 出现崩溃并已自动恢复。通常不应该发生。你可能需要在 GitHub Issues 页面分享 WCR 和 OBS 日志以寻求帮助。',
  ...
  [Phrase.UpdateStageDownloading]: '正在下载更新…',
  [Phrase.UpdateStageVerifying]: '正在验证校验和…',
  [Phrase.UpdateStageInstalling]: '正在安装更新…',
  [Phrase.UpdateStageRelaunching]: '正在重启应用…',
  [Phrase.UpdateFailedText]: '更新失败。您可以重试或关闭此对话框。',
  [Phrase.UpdateInstalledRelaunching]: '更新已安装 — 正在重启应用…',
  [Phrase.Saving]: '保存',
