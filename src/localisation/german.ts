...
const GERMAN: Translations = {
  ...
  [Phrase.ObsCaptureModeDescription]: 'Der Aufnahmemodus der von OBS zur Aufnahme genutzt werden soll.',
  ...
  [Phrase.CrashHappenedText]: 'Ein OBS Absturz ist aufgetreten und wurde sich von erholt. Dies sollte im Normalfall nicht passieren. Vielleicht möchtest du Hilfe suchen, in dem du deine Warcraft Recorder und OBS Logs auf der GitHub Issues-Seite teilst.',
  ...
  [Phrase.UpdateStageDownloading]: 'Update wird heruntergeladen…',
  [Phrase.UpdateStageVerifying]: 'Prüfsumme wird verifiziert…',
  [Phrase.UpdateStageInstalling]: 'Update wird installiert…',
  [Phrase.UpdateStageRelaunching]: 'App wird neugestartet…',
  [Phrase.UpdateFailedText]: 'Update fehlgeschlagen. Sie können es erneut versuchen oder schließen.',
  [Phrase.UpdateInstalledRelaunching]: 'Update installiert — App wird neugestartet…',
