...
const DateRangePicker = (props: IProps) => {
  ...
  return (
    <Datepicker
      ...
      inputClassName="relative transition-colors duration-75 h-[38px] pl-4 pr-14 w-full border border-background bg-card text-foreground placeholder:text-foreground rounded-lg text-sm placeholder:text-sm"
      i18n={i18n}
      configs={configs}
    />
  );
