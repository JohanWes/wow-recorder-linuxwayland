...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.Trigger
    ref={ref}
    className={cn(
      'h-[calc(100%+1px)] inline-flex items-center justify-center whitespace-nowrap px-3 py-1.5 text-base font-medium ring-offset-background transition-colors duration-75',
